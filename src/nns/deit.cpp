...
static Network gen_deit(len_t num_layers, len_t patch_size=16, len_t num_patches=197, len_t embed_dim=768, len_t num_heads=12, len_t ff_dim=3072){
	Network n;
...
const Network deit_base = gen_deit(12);
const Network deit_small = gen_deit(12, 16, 197, 384, 6, 1536);